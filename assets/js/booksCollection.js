...
let book1= new Book(
    ...
    `${imgPath}Tome1.png`, 'Charlie Parker Serie',1,"https://www.johnconnollybooks.com/books/-every-dead-thing----------------------------");
...
let book2= new Book(
    ...
    `${imgPath}Tome2.png`,'Charlie Parker Serie',2,"https://www.johnconnollybooks.com/books/-dark-hollow---------------------------------");
...
let book3= new Book(
    ...
    `${imgPath}Tome3.png`,'Charlie Parker Serie',3,"https://www.johnconnollybooks.com/books/-the-killing-kind----------------------------");
...
let book4= new Book(
    ...
    `${imgPath}Tome4.png`,'Charlie Parker Serie',4,"https://www.johnconnollybooks.com/books/-the-white-road------------------------------");
...
let book5= new Book(
    ...
    `${imgPath}Tome5.png`,'Charlie Parker Serie',5,"https://www.johnconnollybooks.com/books/the-black-angel");
...
booksCollection.push(book1,book2,book3,book4,book5,book6,book7,book8,book9,book10);
