...
//create the delete btn of the card by adding btn and img element
function createDeleteBtn() {
    let deleteBtn = createBtn("btn,deleteBtn,align-self-end,mt-2");
    let trashIcon = createCardTrashIcon();
    deleteBtn.appendChild(trashIcon);
    return deleteBtn;
}

//create the btn element
function createBtn(classNames) {
...
function createCardTrashIcon() {
    ...
    setImgAttributes(icon, null, "deleteIcon", "assets/img/trash.svg", "trashIcon");
    return icon;
}
